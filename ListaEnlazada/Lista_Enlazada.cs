...
namespace EDU4_Algoritmos
{
    public class Lista_Enlazad
    {
        ...
        public void InsertarALaCabeza(NodoLista dato)
        {
            ...
            if (dato.Nombre != null)
                nuevo = new NodoLista(dato.ArrInt, dato.Nombre);
            else
            {
                nuevo = new NodoLista(dato.ArrInt, $"Arreglo sin nombre #{cont}");
                cont++;
            }
        ...
        public void InsertarAlFinal(NodoLista dato)
        {
            ...
            else
            {
                ...
                final = cabeza;
                //Cabeza = nuevo nodo
                cabeza = new NodoLista(dato.ArrInt, dato.Nombre);
